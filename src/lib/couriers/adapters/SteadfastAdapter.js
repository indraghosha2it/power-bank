...
//         return { success: true, message: `Steadfast API connected. Balance: ৳${balance}` };
//       }
//       if (response.status === 401) {
//         return { success: false, message: `Steadfast API Error: ${data?.message || 'Unauthorized'}` };
//       }
//       return { success: false, message: `Steadfast API Error: ${data?.message || 'Unknown error'}` };
//     } catch (error) {
...
//       return {
//         success: true,
//         courierOrderId: orderInfo?.order_id || orderInfo?.id,
//         trackingNumber: orderInfo?.tracking_code || orderInfo?.tracking_number,
...
//       return { success: true, status: data.delivery_status || 'Unknown', fullResponse: data };
//     } catch (error) {
//       return { success: false, message: error.message };
//     }
//   }
